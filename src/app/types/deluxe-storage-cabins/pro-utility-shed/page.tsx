...
const galleryImages = [{
  ...
  alt: 'Summit Utility Shed - Gray with white trim'
}, {
  src: cloudinaryImages.utilityShed2,
  alt: 'Summit Utility Shed - Tan with brown trim'
}, {
  src: cloudinaryImages.utilityShed3,
  alt: 'Summit Utility Shed - White exterior'
}, {
  src: cloudinaryImages.utilityShed4,
  alt: 'Summit Utility Shed - Brown rustic style'
}, {
  src: cloudinaryImages.sideUtility1,
  alt: 'Summit Side Utility - Gray with side door'
}, {
  src: cloudinaryImages.sideUtility2,
  alt: 'Summit Side Utility - White with windows'
}, {
  src: cloudinaryImages.sideUtility3,
  alt: 'Summit Side Utility - Tan with shutters'
}, {
  src: cloudinaryImages.sideUtility4,
  alt: 'Summit Side Utility - Dark brown finish'
}, {
  src: cloudinaryImages.treatedGardenShed,
  alt: 'Treated garden shed with black shutters'
}];

// Combined features for Pro - Utility Shed

// Combined features for Pro - Utility Shed
const proUtilityFeatures = ["Double 36\" Doors w/ T-Handle Lock & Key", "3/4\" T & G Advantech Flooring", "Mesh Vented Ridge", "Moisture Barrier & Drip Edge on Roof", "7'9\" (93\") Wall Height", "16\" O.C. Wall Studs", "16\" O.C. Rafters", "Set of 2 Door Holders (Keep the Doors Open)", "Side or Front Door Entry Options", "Additional Doors & Windows Available", "Customizable Layout for Any Use"];
...
const ProUtilityShedPage = () => {
  return <>
      <Head>
        <title>Pro - Utility Shed | Summit Portable Buildings</title>
        <meta name="description" content="The Pro Utility Shed is a classy, yet simple addition to your property. Perfect for outdoor power equipment, tack rooms, hay sheds, workshops, or even a lake cabin. Available with standard or side door entry. Sizes 8×8 to 14×40. Free delivery within 50 miles." />
        <meta property="og:title" content="Pro - Utility Shed | Summit Portable Buildings" />
        <meta property="og:description" content="A classy, yet simple addition to your property. Superior workmanship makes it the obvious choice for your storage needs. Available as standard utility or side utility with windows." />
          ...
          <section className="pt-32 pb-16 min-h-[600px] lg:min-h-[700px] bg-gradient-to-br from-navy via-navy-dark to-navy flex items-center">
            <div className="container-custom">
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                <div>
                  <Link to="/types/deluxe-storage-cabins#pro-utility" className="inline-flex items-center gap-2 text-secondary/80 hover:text-secondary mb-4 transition-colors">
                ...
                <div className="relative">
                  <Image src={cloudinaryImages.utilityShed1} className="rounded-2xl shadow-2xl w-full" width={500} height={300} />
            ...
            <div className="container-custom">
              <div className="max-w-4xl mx-auto">
                ...
                <div className="grid md:grid-cols-2 gap-8 items-center">
                  <div className="relative">
                    <Image src={cloudinaryImages.sideUtility1} className="rounded-xl shadow-lg w-full" width={500} height={300} />
                  ...
                  <div className="bg-card rounded-xl p-8 border border-border shadow-lg">
                    ...
                    <div className="space-y-3">
                      {proUtilityFeatures.map(feature => <div key={feature} className="flex items-center gap-3 text-foreground">
            ...
            <div className="container-custom">
              <div className="max-w-4xl mx-auto">
                ...
                <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6">
                  {['Outdoor Power Equipment Storage', 'Portable Tack Room', 'Small Hay Shed', 'Workshop (Mechanic/Woodworking)', 'Lake or Hunting Cabin', 'Garden Shed', 'Tool Storage', 'Hobby Space', 'Home Office'].map(use => <div key={use} className="flex items-center gap-3 bg-card p-4 rounded-lg border border-border/50">
                      <Check className="w-5 h-5 text-secondary flex-shrink-0" />
...
export default ProUtilityShedPage;