...
const galleryImages = [{
  ...
  alt: 'Budget Pro Lofted Barn - Main image'
}, {
  src: cloudinaryImages.budgetProLoftedBarn2,
  alt: 'Budget Pro Lofted Barn - Tan with black trim'
}, {
  src: cloudinaryImages.budgetProLoftedBarn3,
  alt: 'Budget Pro Lofted Barn - Green exterior'
}];

// Features for Budget Pro - Lofted Barn

// Features for Budget Pro - Lofted Barn
const budgetProLoftedBarnFeatures = ["Double 36\" Doors w/ T-Handle Lock & Key", "1 Loft for Extra Storage", "5/8\" Subfloor", "6'6\" (78\") Wall Height", "24\" O.C. Wall Studs", "48\" O.C. Rafters w/ 2x4 Lathing", "Side or Front Door Entry Options", "Additional Doors & Windows Available", "Customizable Layout for Any Use"];
...
const BudgetProLoftedBarnPage = () => {
  return <>
      <Head>
        <title>Budget Pro - Lofted Barn | Summit Portable Buildings</title>
        <meta name="description" content="The Budget Pro Lofted Barn offers classic barn styling at an affordable price. Features 1 loft for extra storage, double doors with T-handle lock, and customizable options. Sizes 8×8 to 14×40. Free delivery within 50 miles." />
        <meta property="og:title" content="Budget Pro - Lofted Barn | Summit Portable Buildings" />
        <meta property="og:description" content="Classic barn styling at an affordable price with 1 loft for extra storage and customizable layout options." />
          ...
          <section className="pt-32 pb-16 min-h-[600px] lg:min-h-[700px] bg-gradient-to-br from-navy via-navy-dark to-navy flex items-center">
            <div className="container-custom">
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                <div>
                  <Link to="/types/basic-storage#budget-pro-lofted-barn" className="inline-flex items-center gap-2 text-secondary/80 hover:text-secondary mb-4 transition-colors">
                  ...
                  <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading text-primary-foreground leading-tight mb-6">
                    BUDGET PRO - <span className="text-secondary">LOFTED BARN</span>
                  </h1>
                  <p className="text-lg text-primary-foreground/80 mb-6">
                    Get <strong className="text-secondary">CLASSIC BARN STYLING</strong> at an affordable price. The Budget Pro Lofted Barn features the timeless gambrel roof design with 1 loft for extra storage space. Perfect for those who want quality and style without breaking the bank.
                  </p>
                ...
                <div className="relative">
                  <Image src={cloudinaryImages.budgetProLoftedBarn} className="rounded-2xl shadow-2xl w-full" width={500} height={300} />
            ...
            <div className="container-custom">
              <div className="max-w-4xl mx-auto">
                ...
                <div className="grid md:grid-cols-2 gap-8 items-center">
                  <div className="relative">
                    <Image src={cloudinaryImages.budgetProLoftedBarn} className="rounded-xl shadow-lg w-full" width={500} height={300} />
                  ...
                  <div className="bg-card rounded-xl p-8 border border-border shadow-lg">
                    ...
                    <div className="space-y-3">
                      {budgetProLoftedBarnFeatures.map(feature => <div key={feature} className="flex items-center gap-3 text-foreground">
            ...
            <div className="container-custom">
              <div className="max-w-4xl mx-auto">
                ...
                <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6">
                  {['Organized Storage with Loft', 'Workshop Space', 'Garden Shed', 'Tool Storage', 'Hobby Space', 'Home Office', 'Art Studio', 'Man Cave / She Shed', 'Backyard Retreat'].map(use => <div key={use} className="flex items-center gap-3 bg-card p-4 rounded-lg border border-border/50">
                      <Check className="w-5 h-5 text-secondary flex-shrink-0" />
                      <span className="text-foreground font-medium">{use}</span>
                    </div>)}
                </div>
                <p className="text-center text-muted-foreground mt-8 text-sm">
                  If you are on a budget and looking for a classy barn-style shed which you will feel proud to call your own, this is the perfect choice!
                </p>
              </div>
            </div>
          </section>
...
export default BudgetProLoftedBarnPage;